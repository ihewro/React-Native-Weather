    ...
    render(){
        ...
        return(
            <View style={styles.container}>
                <Text style={AppStyle.smallNumber}>空气质量</Text>
                <Divider/>
                ...
                <View style={styles.currentIndicator}>
                    <Image source={require('../assets/water.png')} style={[styles.indicatorImage,{tintColor:this._handleIndicatorColor(marginLeftValue),marginLeft:(parseInt(offset)+5)}]}/>
